...
While writing this tutorial I used Ubuntu 16.04.
Something to note is you can replace "/home/yourname" with "~" (tilde) on most Unix systems, to shorten commands.
...
On all the below commands, you need to open Makefile.Release and add:
